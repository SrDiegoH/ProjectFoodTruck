        ...
        <div id="skrollr-body">
				...
				<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
				    ...
				    <div class="collapse navbar-collapse" id="navbarNavDropdown">
				        <ul class="navbar-nav">
			                ...
			                <li class="nav-item"><a class="nav-link active" onclick="fnDirecionaPagina('senha')">Alterar Senha</a></li>
			...
			<div class="mobile-hide">
			    <ul class="nav nav-tabs" role="tablist">
			        ...
			        <li class="nav-item"><a class="nav-link active" data-toggle="tab"   role="tab" aria-controls="home" onclick="fnDirecionaPagina('senha')">Alterar Senha</a></li>
            ...
            <div id="skrollr-form">
                <form id="form-atualizacao" action="FachadaAlterarSenha" method="post" style="max-width: 330px; padding: 15px; margin: 0 auto;">
                    ...
                    <input type="password" class="form-control" size="20" maxlength="100" name="novaSenha" placeholder="Nova senha (8 a 16 caracteres, com letras maiúsculas, minúsculas e números)" id="senha" aria-describedby="basic-addon1" required="true" style="border-radius: 0px 0px 0px 0px;">
