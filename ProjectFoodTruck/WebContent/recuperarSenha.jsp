...
<html>
    ...
    <body>
        <div id="skrollr-body">
            ...
            <div id="skrollr-form">
                <form id="form-login" action="FachadaRecuperarSenha" method="post" style="max-width: 330px; padding: 15px; margin: 0 auto;">
                    <h2 class="form-signin-heading">Informe seu E-mail</h2>
                    <br />
                    ...
                    <input type="email" id="email" name="email" class="form-control" placeholder="Email" required="true" autofocus="true">
                    <br />
                    <div class="btn-toolbar" role="toolbar" aria-label="..." style="display: block;">
                        <a><input type="submit" value="Enviar" class="btn btn-primary btn-block" /></a>
                        <a href="login.jsp"><input type="button" value="Cancelar" class="btn btn-danger btn-block" /></a>
                    </div>
                </form>
            </div>
        </div>
